    ...
    <div ref={ref} className="relative">
      <div
        ...
        className={clsx(
          ...
          currentDelay > 0 && 'bg-[#F5C518] text-white rounded-full'
        )}
      >
        <DelayIcon />
      </div>
            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[#0F3D2E] text-white hover:bg-[#0F3D2E]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[#0F3D2E]',
                  isCustomDelay ? 'border-[#0F3D2E]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-[#0F3D2E] text-white text-[12px] font-[600] hover:bg-[#0F3D2E]/80"
              >
                Set
              </button>
            </div>
